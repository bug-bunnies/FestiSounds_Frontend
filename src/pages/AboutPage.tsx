      ...
      <div className="flex justify-center bg-spotify-black">
        <div className="max-w-screen-2xl p-3 ">
          ...
          <h1 className="p-5 text-center text-3xl font-extrabold leading-none tracking-tight text-spotify-white md:text-5xl lg:text-6xl">
            We want to enhance your festival experience and help upcoming
            artists.
          </h1>
          ...
          <div className="mb-6 px-5 text-lg font-normal text-spotify-light-grey sm:px-16 lg:text-xl xl:px-48 ">
            ...
            <p>
              ...
              mission is to enhance your festival experience by introducing you
              to up-and-coming artists who are ready to take the stage. Whether
              you're planning your festival itinerary or looking for a new sound
              to accompany your daily routine,
              <span className="text-spotify-green"> FestiSounds</span> is here
              to help you connect with artists that move and inspire you.
            </p>
            <br />
            <p>
              But
              <span className="text-spotify-green"> FestiSounds</span> isn't
              just about music discovery. It's about supporting artists who are
              just starting to make their mark on the world. When you use
              <span className="text-spotify-green"> FestiSounds</span>, you're
              not just finding new music; you're helping lesser-known artists
              connect with audiences they might not have reached otherwise.
            </p>
            <br />
            <p>
              <span className="text-spotify-green"> FestiSounds</span> is your
              ticket to a world of music waiting to be explored. Let's set out
              on this journey together, one festival at a time.
            </p>
            <hr className="my-8 h-px bg-spotify-grey"></hr>
          </div>
