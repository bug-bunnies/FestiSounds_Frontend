...
const Features = () => {
  return (
    <div className="grid p-3 grid-cols-2 gap-[1.5rem] bg-gradient-to-b from-spotify-black from-10% via-spotify-green to-spotify-black to-90% items-center justify-center">
