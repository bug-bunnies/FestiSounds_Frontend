...
const Features = () => {
  return (
    <div className="grid md:grid-cols-2 items-center justify-center gap-[1.5rem] bg-gradient-to-b from-spotify-black from-10% via-spotify-green to-spotify-black to-90% p-3">
      <div className="grid gap-4 justify-self-end align-middle">
        <FeatureCard
          imgUrl={featuresArtistsImg}
          title={"Explore New Artists"}
          description={
            "Explore the artists at your upcoming festivals that we know you'll love, before you find them."
          }
        />
      </div>
